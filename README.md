...
# v3.0 and older are deprecated
v3.0 and older are no longer maintained and we encourage everyone to convert to v4.0 which is compatible with esphome 2025.2 and newer. This branch is only here for reference.
